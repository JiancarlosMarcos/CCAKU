...
<x-app-layout>
    ...
    <div id="app" class="container">
        <br><br><br><br>
                        ...
                        <img class="logo" style="margin-left:-300px;width:35px;height:35px" src='{{url("/image/icono_1.png") }}'>
                        </a>
                        </center>
                            
                        <center style="margin-top:-28px;position:relative;">
                        <a href="resultados.php?categoria=2">
                        <img class="logo" style="margin-left:365px;width:35px;height:35px" src='{{url("/image/icono_3.png") }}'>
                        </a>
                        </center>
                        <!--fondo de buscador-->
                        ...
                        src='{{url("/image/sin-fondo.png") }}'></a>
                        </center>
                        
                        <center style="margin-top:-21px">
                        <a href="resultados.php?categoria=4">
                        <img class="logo" style="margin-left:310px;width:35px;height:35px" src='{{url("/image/icono_4.png") }}'>
                        </a>
                        </center>
                        
                         <center style="margin-top:-45px">
                         <a href="resultados.php?categoria=3">
                         <img class="logo" style=" margin-left:-330px;width:35px;height:35px" src='{{url("/image/icono_2.png") }}'>
                         </a>
                         </center>
