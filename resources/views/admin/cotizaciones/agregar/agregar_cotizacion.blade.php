...
@include('errores')
<form method="POST" action="{{route('agregar_cotizacion')}}" autocomplete="off" id="add_cotizaciones"
    class="contenido " name="add_cotizaciones">
    @csrf
    ...
    <br>
    @include('admin/cotizaciones/agregar/agregar_cliente')
    <br>
    ...
    <div class="row" style="margin-bottom:5px">
        ...
        <div class="col-md-5">
            <div class="form-group">
                <h5>COSTO TOTAL:</h5> <input class="numberIndistinto" id="costo_total" name="monto_total" style="margin-bottom:5px;border-radius:5px;padding:5px" required><br>
    ...
    <div class="row" style="margin-bottom:5px">
        <div class="col-md-6">
            <div class="form-group">
                <h5>Forma de Pago:</h5>
                <input type="text" value="50% Adelanto y 50% Contraentrega de la Carga." class="form-control"
                    name="forma_pago">
            </div>
        </div>
    </div>
    ...
    <div class="row" style="margin-bottom:5px">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea rows="10" class="form-control" name="descripcion">Cabe indicar que las unidades cuentan con:
• Permisos del MTC a Nivel Nacional.
• Pólizas de Seguro contra todo Riesgo.
• SOAT
• Sistema de monitoreo de GPS
• Mantenimientos preventivos.</textarea>
            </div>
        </div>
    ...
    <button type="submit" class="btn btn-primary btn-sm" style="background:#123;color:#fff;border-color:#777">
        <i class="fa fa-file-text"></i>Crear Cotizacion</button>
</form>
<br>
...
<script>
$('#add_cotizaciones').on('submit', function(evt) {
