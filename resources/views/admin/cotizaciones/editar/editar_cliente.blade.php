<div class="row vista_clientes_existentes ">
    ...
    @include('admin/cotizaciones/editar/editar_carga')
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input class="form-control" type="date" id="fecha_transporte" name="fecha_transporte"
                style="font-weight:600;text-align:center" value="{{ $data_cotizacion->fecha_transporte->format('Y-m-d') }}"
                required>
        </div>
    </div>
    <div class="col-md-3">
...
<div class="row" style="margin-bottom:0px">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="direccion_origen" class="form-control" value="{{$data_cotizacion->direccion_origen}}">
            </select>
        </div>
    </div>
</div>
...
<div class="row" style="margin-bottom:0px">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label" style="font-weight:600;color:#777">DIRECCIÓN</label>
            <input type="text" name="direccion_destino" class="form-control" value="{{$data_cotizacion->direccion_destino}}">
            </select>
        </div>
    </div>
