                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="dni_ruc" type="number" value="{{ old('dni_ruc') }}"
                            autocomplete="off" id="dni_ruc" onkeyup="validar_cliente()" placeholder="RUC O DNI"
                            maxlength="11"
            ...
            <table class="table table-bordered" id="tabla_carga" style="border: 1px solid #123;background:#fff">
                ...
                <thead>
                    <tr>
                        ...
                        <td style="width:8%">Placa <i class="fa-solid fa-circle-question" data-toggle="tooltip"
                                data-original-title="Escribir placa sin guion (-)"></i>
                        </td>
