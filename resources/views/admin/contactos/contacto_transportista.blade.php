...
<div class="app-title contenido hidden">
  <div>
    ...
    <a  href="{{route('transportistas.contactos.mostrar')}}" class="btn btn-primary" style="background:#777;border-color:#777;color:#fff">Contactos de Transportistas</a>
    <a  class="btn btn-primary " style="color:#777;background:#fff;border-color:#777">Vehiculos</a> 
