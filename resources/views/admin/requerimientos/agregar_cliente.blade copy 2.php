...
<div class="row vista_clientes_existentes hidden">
    ...
    <div class="col-md-3" id="div_carga_existente">
        <div class="form-group">
            ...
            <div class="col-md-12 hidden" id="select">
                <div class="form-group">
                    <select class="form-control buscador_cargas required_cliente_existente"
                        onchange="valida_nueva_carga();" id="buscador_carga" name="id_carga" style="width:100%">
                        <option value="" disabled selected> ⌛ Cargando lista ...</option>
...
<script>
    ...
    function valida_nueva_carga() {
        var id_carga = document.getElementById("buscador_carga_tabla").value;
        ...
        if (id_carga == "nueva_carga") {
            ...
            if ($.trim(id_carga) != '') {
                ...
                // $('#carga_existente').removeClass("hidden");
                // $('#div_carga_existente').removeClass("col-md-9");
                // $('#div_carga_existente').addClass("col-md-3");
            }
    ...
    function select_carga_existente() {
        ...
        $('#tabla_carga_e').append(
            ...
            '<td>' +
            '<select class="form-control buscador_cargas required_cliente_existente"' +
            'onchange="valida_nueva_carga();" id="buscador_carga_tabla' + j +
