...
<br>
      <div class="app-title centrar-title">
        <div>
    <a href="{{route('transportistas')}}" class="btn btn-primary" style="background:#777;border-color:#777;color:#fff">Transportistas</a>
   ...
   @include("notificacion")
      <div class="form-card" style="color:#000"><h4>Datos de la Empresa</h4>
      ...
      <div class="row">
       ...
       <div class="col-md-3">
         ...
         <label class="control-label" style="font-weight:600;color:#777">RUC O DNI: <a style="color:#B61A1A">*</a></label>
         <input class="form-control" name="dni_ruc" type="number" value="{{$empresa->dni_ruc}}"
          autocomplete ="off"
          placeholder="RUC O DNI" required />
         </div>
        </div>

        <div class="col-md-3">
         <div class="form-group">
         <label class="control-label" style="font-weight:600;color:#777">NOMBRE: <a style="color:#B61A1A">*</a></label>
