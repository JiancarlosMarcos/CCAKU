...
<br>
      <div class="app-title centrar-title">
        <div>
    <a href="{{route('usuarios')}}" class="btn btn-primary" style="background:#777;border-color:#777;color:#fff">Usuarios</a>
   ...
   @include("notificacion")
      <div class="form-card" style="color:#000"><h4>Datos del Usuario</h4>
      ...
      <div class="row">
       ...
       <div class="col-md-3">
        ...
        <div class="col-md-3">
         <div class="form-group">
         <label class="control-label" style="font-weight:600;color:#777">EMAIL: <a style="color:#B61A1A">*</a></label>
