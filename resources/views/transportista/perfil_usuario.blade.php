...
@section('content')
    ...
    foreach ($contactos as $contacto) {
        if (auth()->user()->id == $contacto->id_users) {
            ...
            $id_transportista = $contacto->id_transportista;
            $dni = $contacto->dni;
    ...
    foreach ($transportistas as $transportista) {
        if ($id_transportista == $transportista->id) {
            $ruc = $transportista->dni_ruc;
            $empresa = $transportista->nombre;
        }
    }
    ?>
    <div class="Perfil">
        ...
        <form method="POST" action="{{ route('actualizar_perfil_transportista') }}" class="centrar-form">
            @csrf
